...
public class EditAdvertComponent : ComponentBase
{
    ...
    protected async Task Load()
    {
        ...
        _advert.MediaFiles = postGetAdvertByIdResult.MediaFiles;
        _advert.IsAdminReviewed = true;
    }
    ...
    protected async Task Form0Submit()
    {
        try
        {
            ...
            _advert.MediaFiles.AddRange(Files.Values.ToList());
    ...
    {
        var image = advert.MediaFiles.Skip(_index).Take(1).FirstOrDefault();
    ...
    {
        advert.MediaFiles.RemoveAt(_index);

        var imagesCount = advert.MediaFiles.Count;

        if(_index > imagesCount - 1)
        {
            _index = 0;
        }
    }
