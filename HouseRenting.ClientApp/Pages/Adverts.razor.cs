...
public class AdvertsComponent : ComponentBase
{
    ...
    protected async Task Grid0LoadData(LoadDataArgs args)
    {
        try
        {
            if (!_isSorted)
            {
                ...
                getAdvertsResult = postGetAdvertsResult.Adverts.Where(_ => _.UserId == Online.Client.Id).AsODataEnumerable();
    ...
    protected async Task GridDeleteButtonClick(MouseEventArgs args, dynamic data)
    {
        ...
        {
            NotificationService.Notify(new NotificationMessage() { Severity = NotificationSeverity.Error, Summary = $"Error", Detail = $"Unable to delete Advert" });
        }
    }
